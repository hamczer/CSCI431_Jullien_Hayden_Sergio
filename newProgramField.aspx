<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newProgramField.aspx.cs" Inherits="presentationOne.WebForm3" %>
			...
			<div class="header">
				<div class="contact">
					<form id="theForm" runat="server">
						<h2 style="font-size:36px;"">Program Field</h2>
						<h2>Please Enter the Information Below</h2>
						<asp:TextBox id="programField" text="Program Field" ValidationGroup="TimeSlot" runat="server" />
						<asp:RequiredFieldValidator ID="programFieldValidator" ErrorMessage="You must enter a program field ^" ControlToValidate="programField" CssClass="required" Display="dynamic" style="" runat="server"></asp:RequiredFieldValidator>
