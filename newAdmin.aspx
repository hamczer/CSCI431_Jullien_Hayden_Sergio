<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newAdmin.aspx.cs" Inherits="presentationOne.WebForm2" %>

<!--
 Filename: newAdmin.aspx
			...
			<div class="header">
				<div class="contact">
					<form id="theForm" runat="server">
						<h2 style="font-size:36px;"">New Admin</h2>
						...
						<asp:TextBox id="accessLevel" text="Requested Access Level" ValidationGroup="TimeSlot" runat="server" />
						<asp:RequiredFieldValidator ID="accessLevelValidator" ErrorMessage="You must entered the requested access level ^" ControlToValidate="accessLevel" CssClass="required" Display="dynamic" style="" runat="server"></asp:RequiredFieldValidator>
